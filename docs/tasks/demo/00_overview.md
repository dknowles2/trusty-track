...
> **Not built.** Nothing in this area ships yet. The absence of a
> `[COMPLETED]` marker on the files here is meaningful — see the plan-file
...
| # | File | What it covers |
| --- | --- | --- |
| 1 | `01_demo_mode_gate.md` | The flag, the policy seam, what is refused, and the test that keeps it honest |
