...
| **Race formats** | Partial Perfect Chart, lane rotation or Perfect-N, championship, elimination, balanced, slowest | Several, more in Pro | Several | Several | Elimination only | Doesn't run races |
