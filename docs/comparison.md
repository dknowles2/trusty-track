...
| **Race formats** | Partial Perfect Chart or lane rotation, championship, elimination, balanced, slowest | Several, more in Pro | Several | Several | Elimination only | Doesn't run races |
