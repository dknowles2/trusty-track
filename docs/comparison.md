...
Nine of Trusty Track's eleven timer profiles are adapted from DerbyNet's protocol
...
| **Timer models listed** | 11 | 6, plus custom in Pro | 8 | Their own | By hand or timer | Not a timer program |
...
Eight of the eleven timer models listed here have never been connected to the
