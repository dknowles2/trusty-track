...
5. (Optional) Pick the den's **Rank** — Lion, Tiger, Wolf, Bear, Webelos or Arrow of Light. It is shown beside the den's name in the list, and beside a racer's name wherever their den is shown on the Standings page and the audience displays.
6. Click **Add Den**.
