...
def test_championship_rounds_populate_sequentially(db: Session):
    ...
    assert not r2_has_placeholders, (
        "Round 2 (Semifinals) should be populated with real racers"
    )
    ...
    assert r3_has_placeholders, (
        "Round 3 (Finals) should NOT be populated yet! It should still have placeholders."
    )
