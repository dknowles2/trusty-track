...
def main() -> None:
    parser = argparse.ArgumentParser(description="Crop an image and convert it to a favicon.")
    parser.add_argument("input", help="Path to the input image")
    parser.add_argument("output", help="Path to the output favicon (.ico)")
    parser.add_argument("--padding", type=int, default=10, help="Padding around the subject (default: 10)")
    parser.add_argument("--no-crop", action="store_true", help="Skip cropping to content")
