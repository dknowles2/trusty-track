...
def generate_fake_racers(db: Session, race_id: int, count: int = 20, add_racer_photos: bool = True, add_car_photos: bool = True, assign_dens: bool = True, check_in: bool = False):
    # Ensure assets exist
