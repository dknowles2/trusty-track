...
| [`ops.md`](.claude/rules/ops.md) | `services/backup.py`, the backup endpoints, HTTPS/`TRUSTYTRACK_HTTP_ONLY`, or the first-run gate | Backup and restore · Networking: HTTPS by default, plain HTTP as an opt-out · First-run gate |
