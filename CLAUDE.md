...
| [`ci.md`](.claude/rules/ci.md) | `.github/workflows/`, the release workflow, or `frontend/e2e/functional/` | What CI checks · Every issue carries a label · What the functional e2e specs are for |
