...
Two images still move, and both are expected: `settings/04-activity-log.png` shows real clock times, and a handful differ by a few dozen pixels of font rasterisation. A run that rewrites *fifty* means something above has been undone.
