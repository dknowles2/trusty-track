...
- `mkdocs build --strict` — a broken link, a missing image.
- `test_docs_stay_current.py` — an operation or a table absent from `design.md` or this file, an entry naming something the schema has lost, an orphaned screenshot.
