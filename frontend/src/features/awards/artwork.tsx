  ...
  return (
    <Frame {...props}>
      ...
      <path
        ...
        strokeWidth={3}
      />
      <rect x="46" y="50" width="8" height="16" fill={BLUE} />
      <rect x="34" y="66" width="32" height="8" rx="3" fill={BLUE} />
      <rect x="26" y="74" width="48" height="8" rx="3" fill={GOLD} stroke={BLUE} strokeWidth={2} />
    </Frame>
  );
}
...
function Medal(props: ArtworkProps) {
  return (
    <Frame {...props}>
      <path d="M38 8 L50 46 L62 8" fill="none" stroke={BLUE} strokeWidth={10} />
      <circle cx="50" cy="66" r="24" fill={GOLD} stroke={BLUE} strokeWidth={3} />
      <path d="M50 52 L57 62 L50 80 L43 62 Z" fill={BLUE} />
    </Frame>
  );
}
...
function Tortoise(props: ArtworkProps) {
  return (
    <Frame {...props}>
      <ellipse cx="50" cy="55" rx="30" ry="22" fill={GOLD} stroke={BLUE} strokeWidth={3} />
      <path
        ...
        opacity={0.6}
      />
      <circle cx="80" cy="46" r="9" fill={GOLD} stroke={BLUE} strokeWidth={3} />
      <circle cx="26" cy="72" r="7" fill={GOLD} stroke={BLUE} strokeWidth={3} />
      <circle cx="70" cy="76" r="7" fill={GOLD} stroke={BLUE} strokeWidth={3} />
      <circle cx="30" cy="34" r="7" fill={GOLD} stroke={BLUE} strokeWidth={3} />
    </Frame>
  );
}
  ...
  return (
    <Frame {...props}>
      <path
        ...
        strokeWidth={3}
      />
      <circle cx="38" cy="30" r="4" fill={BLUE} />
      <circle cx="52" cy="24" r="4" fill="#b60205" />
      <circle cx="64" cy="32" r="4" fill="#2e7d32" />
      <circle cx="30" cy="44" r="4" fill={BLUE} />
    </Frame>
  );
}
...
function FlagStar(props: ArtworkProps) {
  return (
    <Frame {...props}>
      <rect x="30" y="14" width="6" height="70" fill={BLUE} />
      <path d="M36 18h34l-8 12 8 12H36z" fill={GOLD} stroke={BLUE} strokeWidth={3} />
      <path
...
function CompassStar(props: ArtworkProps) {
  return (
    <Frame {...props}>
      <circle cx="50" cy="50" r="34" fill="none" stroke={BLUE} strokeWidth={4} />
      <path d="M50 20 L58 50 L50 80 L42 50 Z" fill={GOLD} stroke={BLUE} strokeWidth={2} />
      <path d="M20 50 L50 42 L80 50 L50 58 Z" fill={BLUE} opacity={0.85} />
...
function Gavel(props: ArtworkProps) {
  return (
    <Frame {...props}>
      ...
      />
      <rect x="18" y="76" width="40" height="8" rx="3" fill={GOLD} stroke={BLUE} strokeWidth={2} />
    </Frame>
  );
}
