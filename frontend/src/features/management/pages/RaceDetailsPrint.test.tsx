...
beforeEach(() => {
    ...
    // No test in this file asserts on a specific mutation — it exercises
    // navigation to the print page — but a shared spy across all ten of
    // `RaceDetails.tsx`'s `useMutation` calls is still the wrong default, so a
    // test added later inherits a discriminating mock rather than a blanket
    // one. Each call gets its own inert spy.
