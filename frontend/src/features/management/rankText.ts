 ...
 *
 * The stored values are the API's (`LION`, `ARROW_OF_LIGHT`), and the den
 * list was showing them as they are stored — "(ARROW_OF_LIGHT)" beside a den
...
/** In the order a Cub Scout meets them, which is how a pack lists its dens. */
 ...
 * enum. Nothing is a blank, since a den without a rank has nothing to say.
 */
